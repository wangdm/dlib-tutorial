...
int main(int argc, char** argv) try
{
    ...
    std::string filename = PROJECT_SOURCE_ROOT "/resource/face/bald_guys.jpg";
    ...
    shape_predictor sp;
    deserialize(PROJECT_SOURCE_ROOT "/resource/model/shape_predictor_5_face_landmarks.dat") >> sp;
    // And finally we load the DNN responsible for face recognition.
    anet_type net;
    deserialize(PROJECT_SOURCE_ROOT "/resource/model/dlib_face_recognition_resnet_model_v1.dat") >> net;
